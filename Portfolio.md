...
A note will disappear once pressed ("Perfect "Good", "Bad") and will fall until it is no longer visible when missed.
...
If I choose to add more content, there should be lag calibration, a pause button activated with double shift during gameplay (exit/ retry), new songs, difficulty levels for each chart, and possibly a multiplayer/ranked mode.
...
### Pseudocode
<img src="timing.png" width="400" height="500">

### Storyboards

<img src="Splashscreen.png" width="400" height="500">
<img src="Gameplays.png" width="400" height="500">
